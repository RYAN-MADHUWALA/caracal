...
The public docs do not document enterprise internals. Enterprise is documented as a user-facing lane, and the SDK sections remain structure-first while their full content is completed in a later phase.
